...
const xml = `<svg id="stop" xmlns="http://www.w3.org/2000/svg" width="15" height="15.001" viewBox="0 0 15 15.001">
...
export default class NonVersion extends React.Component {
  render() {
    return (
      <SvgXml xml={xml} />
    );
